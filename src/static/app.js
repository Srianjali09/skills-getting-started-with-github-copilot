  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
                    ...
                    .map(
                      (participant) =>
                        `<li>
                          ...
                          <button type="button" class="remove-participant" data-email="${participant}" data-activity="${name}" aria-label="Remove ${participant}">×</button>
                        </li>`
                    )
                    .join("")
        ...
        // Add delete handlers to participant remove buttons
